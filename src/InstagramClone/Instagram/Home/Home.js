                ...
                <div className="post">
                    <div className="commonRow">
                        <div className="status">
                            ...
                            <div className="name">
                                <span className="ellipsis">Aimanth</span>
                            </div>
                        </div>
                        <div className="status">
                            <div className="subStatus"></div>
                            <div className="name">
                                <span className="ellipsis">Arnav</span>
                            </div>
                        </div>
                        <div className="status">
                            <div className="subStatus"></div>
                            <div className="name">
                                <span className="ellipsis">Aadesh</span>
                            </div>
                        </div>
                        <div className="status">
                            <div className="subStatus"></div>
                            <div className="name">
                                <span className="ellipsis">Ajith</span>
                            </div>
                        </div>
                        <div className="status">
                            <div className="subStatus"></div>
                            <div className="name">
                                <span className="ellipsis">Ajay</span>
                            </div>
                        </div>
                        <div className="status">
                            <div className="subStatus"></div>
                            <div className="name">
                                <span className="ellipsis">Ashok</span>
                            </div>
                        </div>
                        <div className="status">
                            <div className="subStatus"></div>
                            <div className="name">
                                <span className="ellipsis">Anand</span>
                            </div>
                        </div>
                        <div className="status">
                            <div className="subStatus"></div>
                            <div className="name">
                                <span className="ellipsis">Aryan</span>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="postContainer">
                            <div className="postRow">
                                <div className="commonRow">
                                    ...
                                    <div>
                                        <div>
                                            <span className="postName">Hemanth</span>
                            ...
                            <div>
                                ...
                                <div>
                                    <div>
                                        <span className="postName">love_ethics</span>
                        ...
                        <div className="postContainer">
                            <div className="postRow">
                                <div className="commonRow">
                                    ...
                                    <div>
                                        <div>
                                            <span className="postName">Aimanth</span>
                                            <span className="postDay">. 1d</span>
                                        </div>
                                        <span className="PostDesc">Beast Inside Beats • Vibes</span>
                                    </div>
                ...
                <div className="suggestion">
                    <div className="postRow">
                        <div className="commonRow">
                            ...
                            <div className="suggestionProfile">
                                <span className="postName">programmer__ethics</span><br/>
                                <span className="postDay">Programmer Ethics</span>
                            </div>
                        </div>
                        <div>Switch</div>
                    </div>
                    ...
                    <div className="postRow pding">
                        <div className="commonRow">
                            <div className="postProfile"></div>
                            <div className="suggestionProfile">
                                <span className="postName">Programmer Ethics</span><br/>
                                <span className="followedBy">Followed by Arnav</span>
                            </div>
                        </div>
                    ...
                    <div className="postRow pding">
                        <div className="commonRow">
                            ...
                            <div className="suggestionProfile">
                                <span className="postName">Programmer Ethics</span><br/>
                                <span className="followedBy">Followed by Aryan</span>
                            </div>
                        </div>
                        <div className="switch">Follow</div>
                    </div>
                    <div className="postRow pding">
                        <div className="commonRow">
                            ...
                            <div className="suggestionProfile">
                                <span className="postName">Programmer Ethics</span><br/>
                                <span className="followedBy">Followed by Ajith</span>
                            </div>
                        </div>
                        <div className="switch">Follow</div>
                    </div>
                    <div className="postRow pding">
                        <div className="commonRow">
                            ...
                            <div className="suggestionProfile">
                                <span className="postName">Programmer Ethics</span><br/>
                                <span className="followedBy">Followed by Aadesh</span>
                            </div>
                        </div>
                        <div className="switch">Follow</div>
                    </div>
                    <div className="postRow pding">
                        <div className="commonRow">
                            ...
                            <div className="suggestionProfile">
                                <span className="postName">Programmer Ethics</span><br/>
                                <span className="followedBy">Followed by Ajay</span>
                            </div>
                        </div>
                        <div className="switch">Follow</div>
                    </div>
